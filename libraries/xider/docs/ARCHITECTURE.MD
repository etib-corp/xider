...
- `xider::Renderer` adapts Evan to the Guillaume renderer interface.
- `xider::EventHandler` adapts platform events to Guillaume.
- `xider::scenes::Main` and `xider::scenes::Settings` define the app screens.
